...
addLanguageRoute.get("/add-Language-astrologer", async (req, res) => {
  try {
...
addLanguageRoute.delete("/delete-language-astrologer/:id", async (req, res) => {
    try {
      const { id } = req.params;
...
addLanguageRoute.post("/add-Language-astrologer", async (req, res) => {
  try {
